...
# Note: the code to create Appendix Figure 1 is also found below
...
aggDF.ves0.55<- aggregate(cbind(VE_symptOR_observed, VE_symptOR, VE_symptRR_observed, VE_symptRR,
                                ...
                                NonCovid_cumPropSymptInfect, NonCovid_cumPropSymptInfect_vac, NonCovid_cumPropSymptInfect_unvac,
...
############################
#APPENDIX FIGURE 1
#CUMULATIVE PROPORTIONS OF COVID-LIKE ETIOLOGIES
