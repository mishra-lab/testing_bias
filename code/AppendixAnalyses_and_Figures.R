...
#The following data and function are also used to create Appendix Figure 5, 6 &
#Appendix 1: Effects of Testing Sensitivity Analyses
...
df.ves0.1_testSens$VE_symptOR_degUnder<--1*(0.1 - df.ves0.1_testSens$VE_symptOR_withTestSens_observed)
df.ves0.1_testSens$VE_symptRR_degUnder<--1*(0.1 - df.ves0.1_testSens$VE_symptRR_withTestSens_observed)

df.ves0.55_testSens$VE_symptOR_degUnder<--1*(0.55 - df.ves0.55_testSens$VE_symptOR_withTestSens_observed)
df.ves0.55_testSens$VE_symptRR_degUnder<--1*(0.55 - df.ves0.55_testSens$VE_symptRR_withTestSens_observed)
...
plot.ve.susc0.55_test.sens_modUnequalTest_cohort<-ggplot(df.ves0.55_testSens_modUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptRR_degUnder, fill=as.factor(Test_sens))) +
...
plot.ve.susc0.1_test.sens_modUnequalTest_cohort<-ggplot(df.ves0.1_testSens_modUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptRR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
plot.ve.susc0.55_test.sens_highUnequalTest_cohort<-ggplot(df.ves0.55_testSens_highUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptRR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
plot.ve.susc0.1_test.sens_highUnequalTest_cohort<-ggplot(df.ves0.1_testSens_highUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptRR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
#Save Figures
pdf(file=paste(appfig2.pathway,"AppFig.2a_VE.Susc0.55.ModUnequalTest.CohortDesign.pdf",sep="/"),
    width=8, height=6)
plot.ve.susc0.55_test.sens_modUnequalTest_cohort
dev.off()

pdf(file=paste(appfig2.pathway,"AppFig.2b_VE.Susc0.1.ModUnequalTest.CohortDesign.pdf",sep="/"),
    width=8, height=6)
plot.ve.susc0.1_test.sens_modUnequalTest_cohort
dev.off()

pdf(file=paste(appfig2.pathway,"AppFig.2c_VE.Susc0.55.HighUnequalTest.CohortDesign.pdf",sep="/"),
    width=8, height=6)
plot.ve.susc0.55_test.sens_highUnequalTest_cohort
dev.off()

pdf(file=paste(appfig2.pathway,"AppFig.2d_VE.Susc0.1.HighUnequalTest.CohortDesign.pdf",sep="/"),
    width=8, height=6)
...
#APPENDIX 1: APPENDIX FIGURE 3 CAN BE FOUND AFTER APPENDIX FIGURE 5 & 6

######################################
#APPENDIX 1: APPENDIX FIGURE 5
#TESTING SENSITIVITY WITH UNEQUAL TESTING - TEST-NEGATIVE DESIGN 

#This section follows Appendix Figure 2 as the data and function used to create Appendix Figure 5
#is created above in the Appendix Figure 2 section 
...
##Appendix Figure 5a
#Moderately Unequal Testing - vaccine efficacy against susceptibility=0.55
plot.ve.susc0.55_test.sens_modUnequalTest_tnd<-ggplot(df.ves0.55_testSens_modUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptOR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
##Appendix Figure 5b
#Moderately Unequal Testing - vaccine efficacy against susceptibility=0.1
plot.ve.susc0.1_test.sens_modUnequalTest_tnd<-ggplot(df.ves0.1_testSens_modUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptOR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
##Appendix Figure 5c
#Highly Unequal Testing - vaccine efficacy against susceptibility=0.55
plot.ve.susc0.55_test.sens_highUnequalTest_tnd<-ggplot(df.ves0.55_testSens_highUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptOR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
##Appendix Figure 5d
#Highly Unequal Testing - vaccine efficacy against susceptibility=0.1
plot.ve.susc0.1_test.sens_highUnequalTest_tnd<-ggplot(df.ves0.1_testSens_highUnequalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptOR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
#set pathway to save figures
appfig5.pathway<-paste(pathway,"figures/appendices_figs/app_fig5",sep="/")

#Save Figures
pdf(file=paste(appfig5.pathway,"AppFig.5a_VE.Susc0.55.ModUnequalTest.TND.pdf",sep="/"), 
    width=8, height=6)
plot.ve.susc0.55_test.sens_modUnequalTest_tnd
dev.off()

pdf(file=paste(appfig5.pathway,"AppFig.5b_VE.Susc0.1.ModUnequalTest.TND.pdf",sep="/"), 
    width=8, height=6)
plot.ve.susc0.1_test.sens_modUnequalTest_tnd
dev.off()

pdf(file=paste(appfig5.pathway,"AppFig.5c_VE.Susc0.55.HighUnequalTest.TND.pdf",sep="/"), 
    width=8, height=6)
plot.ve.susc0.55_test.sens_highUnequalTest_tnd
dev.off()

pdf(file=paste(appfig5.pathway,"AppFig.5d_VE.Susc0.1.HighUnequalTest.TND.pdf",sep="/"), 
    width=8, height=6)
...
VE_underestimate.ves0.1.peak.testSens.0.5<-df.ves0.1_testSens_highUnequalTest$VE_symptOR_degUnder[df.ves0.1_testSens_highUnequalTest$Label_epiPhase=="Peak" & df.ves0.1_testSens_highUnequalTest$Test_sens=="0.5"]
VE_underestimate.ves0.1.peak.testSens.1<-df.ves0.1_testSens_highUnequalTest$VE_symptOR_degUnder[df.ves0.1_testSens_highUnequalTest$Label_epiPhase=="Peak" & df.ves0.1_testSens_highUnequalTest$Test_sens=="1"]
...
VE_underestimate.ves0.55.peak.testSens.0.5<-df.ves0.55_testSens_highUnequalTest$VE_symptOR_degUnder[df.ves0.55_testSens_highUnequalTest$Label_epiPhase=="Peak" & df.ves0.55_testSens_highUnequalTest$Test_sens=="0.5"]
VE_underestimate.ves0.55.peak.testSens.1<-df.ves0.55_testSens_highUnequalTest$VE_symptOR_degUnder[df.ves0.55_testSens_highUnequalTest$Label_epiPhase=="Peak" & df.ves0.55_testSens_highUnequalTest$Test_sens=="1"]
...
#This section is out of order as the data and function used to create Appendix Figure 6
...
plot.ve.susc0.55_test.sens_equalTest_tnd<-ggplot(df.ves0.55_testSens_equalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptOR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
plot.ve.susc0.1_test.sens_equalTest_tnd<-ggplot(df.ves0.1_testSens_equalTest,aes(x=as.factor(Label_epiPhase) ,y=VE_symptOR_degUnder, fill=as.factor(Test_sens))) +
  geom_hline(yintercept=0, linetype="dashed", 
             color = "grey40", linewidth=2)+
  geom_violin(aes(fill=as.factor(Test_sens)), trim=FALSE, position = position_dodge(width=0.92),
              width=0.9, scale="width") +   
...
pdf(file=paste(appfig6.pathway,"AppFig.6a_VE.Susc0.55.EqualTest.TND.pdf",sep="/"), 
    width=8, height=6)
plot.ve.susc0.55_test.sens_equalTest_tnd
dev.off()

pdf(file=paste(appfig6.pathway,"AppFig.6b_VE.Susc0.1.EqualTest.TND.pdf",sep="/"), 
    width=8, height=6)
...
#set pathway to save figures
appfig3.pathway<-paste(pathway,"figures/appendices_figs/app_fig3&4",sep="/")

#Save Figures (warning occurs as we include only a certain time range)
pdf(file=paste(appfig3.pathway,"AppFig.3a_CumPropFalseNeg.0.55.pdf",sep="/"), 
    width=7.5, height=6)
Cum.Prop.False.Neg.0.55
dev.off()

pdf(file=paste(appfig3.pathway,"AppFig.3b_CumPropFalseNeg.0.1.pdf",sep="/"), 
    width=7.5, height=6)
...
####################################################
#REMINDER - APPENDIX FIGURE 5, APPENDIX FIGURE 6 &
#SUPPLEMENTARY 1: EFFECTS OF TESTING SENSITIVITY CODE
#CAN BE FOUND BELOW THE CODE FOR APPENDIX FIGURE 2 

######################################################
#APPENDIX 1: APPENDIX FIGURE 7
...
#Save Figures
pdf(file=paste(appfig7.pathway,"AppFig.7a_VE.Susc0.55.OtherEtiologies.pdf",sep="/"), 
    width=8, height=6)
plot.ve.susc0.55_other.etiologies.sens
dev.off()

pdf(file=paste(appfig7.pathway,"AppFig.7b_VE.Susc0.1.OtherEtiologies.pdf",sep="/"), 
    width=8, height=6)
...
low.prevalence<-mean(df.ve.susc0.1_other.etiologies.sens.high$VE_symptOR_degUnder_highChange_trueVeff[df.ve.susc0.1_other.etiologies.sens.high$Label_testingDiff=="highUnequal" & df.ve.susc0.1_other.etiologies.sens.high$NonCovid_propSympt==0.05])
high.prevalence<-mean(df.ve.susc0.1_other.etiologies.sens.high$VE_symptOR_degUnder_highChange_trueVeff[df.ve.susc0.1_other.etiologies.sens.high$Label_testingDiff=="highUnequal" & df.ve.susc0.1_other.etiologies.sens.high$NonCovid_propSympt==0.2])
...
#Uses same data as Appendix Figure 7
...
##Sub-figures for Appendix Figure 8
...
#Save Figure 8 (warnings are just because we are only plotting part of the time we have recorded)
ggarrange(plotlist = plotlist.ve.susc, ncol = 5, nrow = 2) %>%
  ggexport(filename = paste(appfig8.pathway,"AppFig.8_VE.Susc.Infect.Dynamics.Fig.pdf",sep="/"))

###########################################
#APPENDIX 1: APPENDIX FIGURE 9
...
##Sub-figures for Appendix Figure 9
...
#set pathway to save figures
appfig9.pathway<-paste(pathway,"figures/appendices_figs/app_fig9&10",sep="/")

#Save Figure 9 (warnings are just because we are only plotting part of the time we have recorded)
ggarrange(plotlist = plotlist.ve.susc0.55.ve.infect, ncol = 5, nrow = 2) %>%
  ggexport(filename = paste(appfig9.pathway,"AppFig.9_VE.Susc0.55_VE.Infect.Combo.pdf",sep="/"))

###########################################
#APPENDIX 1: APPENDIX FIGURE 10
#VE AGAINST INFECTIOUSNESS SENSITIVITY ANALYSIS APPENDIX
...
##Sub-figures for Appendix Figure 10
#Cum. Prop of symptomatic SARS-CoV-2 when vaccine efficacy against infectiousness=0.1
...
#set pathway to save figures
appfig10.pathway<-paste(pathway,"figures/appendices_figs/app_fig9&10",sep="/")

#Save Figure 10 (warnings are just because we are only plotting part of the time we have recorded)
ggarrange(plotlist = plotlist.ve.susc0.1.ve.infect, ncol = 5, nrow = 2) %>%
  ggexport(filename = paste(appfig10.pathway,"AppFig.10_VE.Susc0.1_VE.Infect.Combo.pdf",sep="/"))

###########################################
#APPENDIX 1: CONTENT FOR APPENDIX FIGURE 11 & 12
...
##Sub-figures for Appendix Figure 15
...
#set pathway to save figures
appfig15.pathway<-paste(pathway,"figures/appendices_figs/app_fig15&16",sep="/")
...
ggarrange(plotlist = plotlist.ve.susc0.55.prob.transmiss, ncol = 4, nrow = 2) %>%
  ggexport(filename = paste(appfig11.pathway,"AppFig.15_VE.Susc0.55_Prob.Transmiss.Combo.pdf",sep="/"))


###########################################
#APPENDIX 1: APPENDIX FIGURE 16
#PROBABILITY OF TRANSMISSION ANALYSIS APPENDIX
...
##Sub-figures for Appendix Figure 16
...
#set pathway to save figures
appfig16.pathway<-paste(pathway,"figures/appendices_figs/app_fig15&16",sep="/")

#Save Figure 16 (warnings are just because we are only plotting part of the time we have recorded)
ggarrange(plotlist = plotlist.ve.susc0.1.prob.transmiss, ncol = 5, nrow = 2) %>%
  ggexport(filename = paste(appfig16.pathway,"AppFig.16_VE.Susc0.1_Prob.Transmiss.Combo.pdf",sep="/"))

###########################################
#APPENDIX 1: CONTENT FOR APPENDIX FIGURE 17 & 18
...
######################################################
#APPENDIX 2: APPENDIX FIGURES 19 & 20
...
#set pathway to save figures
appfig19.pathway<-paste(pathway,"figures/appendices_figs/app_fig19",sep="/")

#Save Figures

pdf(file=paste(appfig19.pathway,"AppFig.19a_VE.RR.0.55.Target.pdf",sep="/"), 
    width=7.5, height=6)
VE.RR.ves0.55_target
dev.off()

pdf(file=paste(appfig19.pathway,"AppFig.19b_VE.RR.0.55.Equal.Testing.pdf",sep="/"), 
    width=7.5, height=6)
VE.RR.ves0.55.equal.testing
dev.off()

pdf(file=paste(appfig19.pathway,"AppFig.19c_VE.OR.0.55.Target.pdf",sep="/"), 
    width=7.5, height=6)
VE.OR.ves0.55_target
dev.off()

pdf(file=paste(appfig19.pathway,"AppFig.19d_VE.OR.0.55.Equal.Testing.pdf",sep="/"), 
    width=7.5, height=6)
...
#set pathway to save figures
appfig20.pathway<-paste(pathway,"figures/appendices_figs/app_fig20",sep="/")

#Save Figures
pdf(file=paste(appfig20.pathway,"AppFig.20a_VE.RR.0.1.Target.pdf",sep="/"), 
    width=7.5, height=6)
VE.RR.ves0.1_target
dev.off()

pdf(file=paste(appfig20.pathway,"AppFig.20b_VE.OR.0.1.Target.pdf",sep="/"), 
    width=7.5, height=6)
VE.OR.ves0.1_target
dev.off()

pdf(file=paste(appfig20.pathway,"AppFig.20c_VE.RR.0.1.Equal.Testing.pdf",sep="/"), 
    width=7.5, height=6)
VE.RR.ves0.1.equal.testing
dev.off()

pdf(file=paste(appfig20.pathway,"AppFig.20d_VE.OR.0.1.Equal.Testing.pdf",sep="/"), 
    width=7.5, height=6)
